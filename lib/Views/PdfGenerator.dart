...
Future<Uint8List> pdfGenerator(
    ...
    String id,
    var dailyData,
    QuerySnapshot<Map<String, dynamic>>? lateMarks,
    QuerySnapshot<Map<String, dynamic>>? feedback) {
                            ...
                            children: [
                                ...
                                dailyData == null
                                    ...
                                    : TableRow(children: [
                                        ...
                                        Column(children: [
                                          Text(
                                              "$UnifromCount/${((UnifromCount / totalDailyDataEntryCount) * 100) == 0 || ((UnifromCount / totalDailyDataEntryCount) * 100) == 100 ? ((UnifromCount / totalDailyDataEntryCount) * 100) : ((UnifromCount / totalDailyDataEntryCount) * 100).toString().substring(0, 2)}",
                                              style: TextStyle(
                                                  fontWeight: FontWeight.bold))
                                        ]),
                                        Column(children: [
                                          Text(
                                              "$SignCount/${((SignCount / totalDailyDataEntryCount) * 100) == 0 || ((SignCount / totalDailyDataEntryCount) * 100) == 100 ? ((SignCount / totalDailyDataEntryCount) * 100) : ((SignCount / totalDailyDataEntryCount) * 100).toString().substring(0, 2)}",
                                              style: TextStyle(
                                                  fontWeight: FontWeight.bold))
                                        ]),
                                        Column(children: [
                                        ...
                                        Column(children: [
                                          Text(
                                              "$IdcardCount/${((IdcardCount / totalDailyDataEntryCount) * 100) == 0 || ((IdcardCount / totalDailyDataEntryCount) * 100) == 100 ? ((IdcardCount / totalDailyDataEntryCount) * 100) : ((IdcardCount / totalDailyDataEntryCount) * 100).toString().substring(0, 2)}",
                                              style: TextStyle(
                                                  fontWeight: FontWeight.bold))
                                        ]),
                                      ]),
