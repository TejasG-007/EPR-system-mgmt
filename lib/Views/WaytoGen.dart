...
class WaytoGenerate extends StatefulWidget {

  @override
  State<WaytoGenerate> createState() => _WaytoGenerateState();
}


class _WaytoGenerateState extends State<WaytoGenerate> {
  
  
  String userid = Get.arguments[1]["userid"];
  
  PersonalDataUpdate userdata = Get.arguments[0]["Personaldata"];
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          FutureBuilder(
              future: getDailyUpdateData(userid),
              builder: (context, data) {
                sortingofDailyData() {
                  if (data.hasData) {
                    for (var item in data.data!) {
